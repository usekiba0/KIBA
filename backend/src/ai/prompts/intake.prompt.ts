    ...
    switch (phase) {
      case 'BUILD':
        return [
          ...
          `8. THE ${d}-DAY CHALLENGE (a dare, NOT a sales close) — get a real yes BEFORE any money, but frame it as a challenge built around THEIR goal, never an interrogation. Put it on the table ONCE, naturally and specific to what they want to get done: e.g. "here's the move. give me the next ${d} days. i'm on you every morning till [their goal] is actually moving. you in?" Make it feel like a dare they want to take. HARD BANNED (these are exactly what reads pushy/salesy and loses people): "are you serious or just interested", "you ready to let me stay on you every single day", "no half measures", or any version that grills them on how committed they are. Ask ONCE — if they give any kind of yes, go straight to the close. NEVER repeat the ask or re-grill them.`,
