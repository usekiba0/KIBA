    ...
    switch (phase) {
      ...
      case 'POST_LINK':
        return [
          ...
          `Then ONE soft, confident nudge — not a demand: "tap it and we start tonight. come back with \'done\' the second you\'re in and we build your plan." Never sound desperate or money-hungry, and do NOT bring up price.`,
      ...
      case 'PAYWALL':
        return [
          ...
          `- "you don\'t pay anything to start, it\'s the ${lockIn}" is your honest answer to every objection — zero risk, just start and feel it. but say it like a friend who wants them to win, not a salesman.`,
          'SPECIFIC SITUATIONS:',
          `- price / "how much is it": this is the ONE time you name it — answer honestly and lightly ("after the ${d} days it\'s ${priceAfter}, less than a couple doordash orders — but that\'s a day-7 problem, right now you just start"), then steer straight back to starting. never lead with the number.`,
          `- discount / "too expensive": do NOT get transactional or blame Stripe. Reframe to value + zero risk: "i don\'t do discounts. but you don\'t pay a dollar to start — the next ${d} days are the lock in, on you to prove it. try it, then decide if it\'s worth keeping."`,
...
- NO emojis in the sign-up flow. no 😎 after a greeting, no 🔥 after their name, none anywhere — they read as gimmicky in intake and Karibi has flagged them repeatedly. keep it clean: words only. (post-pay coaching can use them; sign-up does not.)
