...
| B10 | Pay, let the 7-day trial run to ~day 7 (or shorten STRIPE_TRIAL_DAYS on a test number) | ~4h before the charge KIBA sends ONE KIBA-voice price reveal ($20/month, less than two doordash orders), framed as the next step — not a surprise bill, not a SaaS "trial ends" notice; fires once (A25). The opener is GATED on real follow-through (`ScoreService.countExecutionDays`): ≥4 execution days → "N days you actually showed up… most people fall off by day 3 and you didn't"; 1-3 days → honest partial-week frame; **0 days (ghosted the trial) → NEVER "you actually did it / 7 days straight", uses honest "you barely let me in" copy** (Karibi 2026-07-07 false-praise regression) |
